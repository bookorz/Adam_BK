...
namespace Adam
{
    public partial class FormUnitCtrlData : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(strMsg, "Manual", MessageBoxButtons.OKCancel, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1, MessageBoxOptions.ServiceNotification);
        }
    }
}
